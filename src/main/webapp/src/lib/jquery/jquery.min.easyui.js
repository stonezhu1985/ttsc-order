...
var $jq = jQuery.noConflict(true);console.log('$ : ' + $().jquery);console.log('$jq : ' + $jq().jquery);
...
(function($){
    ...
    $.fn.combobox.defaults=$.extend({},$.fn.combo.defaults,{valueField:"value",textField:"text",groupField:null,groupFormatter:function(_919){
        ...
        var _922=(p instanceof $jq)?p.attr("id").substr(_921.itemIdPrefix.length+1):_8d9(_920,p);
